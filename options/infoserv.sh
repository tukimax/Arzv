...
echo -e " Fail2Ban                : Service is $status_fail2ban"
echo -e " Crons                   : Service is $status_cron"
echo -e " Vnstat                  : Service is $status_vnstat"
echo -e " XRAY TLS                : Service is $status_tls_v2ray"
echo -e " XRAY None TLS           : Service is $status_nontls_v2ray"
echo -e " XRAY Vmess TLS          : Service is $status_tls_v2ray"
echo -e " XRAY Vmess None TLS     : Service is $status_nontls_v2ray"
